...
async function testBackendQuery() {
  ...
  try {
    ...
    // 1. Obtener encuestas activas (primera consulta del backend)
    ...
    // 2. Para cada encuesta, obtener opciones (segunda consulta del backend)
    for (let survey of surveys) {
      console.log(`\n📡 Consulta 2: Opciones para survey ${survey.id}`);
      ...
      console.log(`   Resultado para survey ${survey.id} (total_votes: ${survey.total_votes}):`);
