...
cp cpanel_start.sh "$TEMP_DIR/start.sh"
...
echo "2. Extrae el archivo en el directorio raíz de tu sitio web"
echo "3. Ejecuta 'bash start.sh' para iniciar la aplicación"
echo "4. Asegúrate de actualizar la contraseña de la base de datos en el archivo .env"
echo "=======================" 