    ...
    schema: {
      ...
      body: {
        ...
        properties: {
          ...
          diario: { type: 'string', maxLength: 100, nullable: true },
    ...
    schema: {
      ...
      body: {
        ...
        properties: {
          ...
          image_thumbnail_url: { type: 'string', nullable: true, description: 'URL de miniatura/img_miniatura (opcional)' },
          original_url: { type: 'string', nullable: true, description: 'URL original de WordPress (opcional)' },
          diario: { type: 'string', nullable: true, description: 'Nombre del medio/diario' },
          categoria: { type: 'string', nullable: true, description: 'Categoría de la noticia' },
