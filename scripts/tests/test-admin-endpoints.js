...
async function testAdminEndpoints() {
  console.log('🧪 Probando endpoints de administración...\n');
  ...
  try {
    ...
    if (loginResponse.data.token) {
      ...
      // 3. Probar endpoint de estado de BD
      console.log('\n3️⃣ Probando GET /admin/database/status...');
      try {
      ...
      // 4. Probar endpoint de optimizar BD
      console.log('\n4️⃣ Probando POST /admin/database/optimize...');
      try {
      ...
      // 5. Probar endpoint de limpiar logs
      console.log('\n5️⃣ Probando POST /admin/system/clear-logs...');
      try {
